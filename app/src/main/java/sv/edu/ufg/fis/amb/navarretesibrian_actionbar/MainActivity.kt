...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId)
        {
            ...
            R.id.mapa -> {
                Toast.makeText(this,"usted ha seleccionado la opcion para enviar su ubicacion",Toast.LENGTH_SHORT).show()
                true
            }

            R.id.nueva_cuenta -> {
                Toast.makeText(this,"usted ha seleccionado la opcion para agregar una nueva cuenta",Toast.LENGTH_SHORT).show()
                true
            }
